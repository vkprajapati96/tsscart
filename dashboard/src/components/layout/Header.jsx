...
const Header = ( { sideBarCollapsed, onToggleSideBar } ) => {
  return (
    ...
    <p>welcome back, Alex! here's what's happing today </p>
    </div>
        </div>
        {/* center section */}
        <div className='flex-1 max-w-md mx-8'>
            <div className='relative'>
                ...
                className='w-full pl-10 pr-4 py-2.5 bg-slate-100 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 
                rounded-xl text-slate-800 dark:text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-blue-500
            ...
            <div className='flex items-center space-x-3'>
                {/* quic action */}
                <button className='hidden lg:flex items-center space-x-2 py-2 px-4 bg-gradient-to-r from-blue-500 to-purple-600 text-white
                ...
                <button className='relative p-2.5 rounded-xl text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors'>
                        ...
                        <span className='absolute -top-1 w-5 h-5 bg-red-500 text-white text-xs rounded-full felx items-center justify-center'> 3</span>
                </button>
                ...
                <div className='flex items-center space-x-3 pl-3 border-1 border-s-teal-200 dark:border-slate-700'>
                        <img 
                        src={pic} 
                        alt=""
                        ...
                        <p className='text-sm font-medium text-slate-500 dark:text-slate-400'>Vishal Daksh</p>
